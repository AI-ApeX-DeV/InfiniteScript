...
int main(){
    ...
    int num[] {1,2,3,4,5}; 
    std::cout << "The num is : " << sizeof(num) << std::endl;
    char num1[] {"this is good"};
    std::cout << "The num is : " << sizeof(num1) << std::endl;
    char num2[] {'a','b','b','b','b','b','b'} ;
    std::cout << "The num is : " << sizeof(num2) << std::endl;
    char num3[] {'a','b','b','b','b','b'} ;
    std::cout << "The num is : " << sizeof(num3) << std::endl;
    char num4[6] {'a','b','b','b','b','b'} ;
    std::cout << "The num is : " << sizeof(num4) << std::endl;
    char num5[6] {'a','b','b','b','b'} ;
     std::cout<<"cool"<<num5[5];
    std::cout << "The num is : " << sizeof(num5) << std::endl;
    char num6[6] {'a','b','b','b'} ;
    std::cout << "The num is : " << sizeof(num6) << std::endl;
    std::cout<<"cool"<<num6[5];
